...
Today, token launches often reward participants for **getting positioned before everyone else**. Creators, insiders, bots, and sophisticated traders compete for early allocation, while promoters are incentivized to attract subsequent buyers.

This can create an extractive cycle:

**Get positioned early → generate attention → attract demand → sell into that demand.**

Prysma takes a different approach. Instead of rewarding participants primarily for being early, we aim to reward them for **contributing to the creation of the market itself.**
...
Prysma aims to preserve the useful coordination properties of token launches without making **being early** the primary economic advantage.
...
Prysma uses Uniswap's Continuous Clearing Auction as the foundation of its launch mechanism.
...
Prysma therefore treats **distribution as a separate part of the launch mechanism.**

## Incentivizing contribution

Prysma allows participants to distribute launches through referral links.

When a distributor brings participants into an auction, the protocol tracks the bid volume they contribute.

Rather than paying a one-time referral bounty, Prysma connects the distributor's reward to the market they helped create.
...
## What Prysma is designed to solve

Prysma does not attempt to guarantee that tokens will retain value or remain relevant indefinitely.
...
Prysma starts with a narrower question:
...
**Prysma is designing manipulation-resistant token markets through better incentives.**
